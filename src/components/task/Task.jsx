...
function Task(props) {
  ...
  return (
    <Col xs={12} sm={6} md={4} lg={3}>
      <Card className={`mt-2 mb-2 ${styles.taskbg}`}>
        <Card.Body>
          <Form.Check
          ...
          <Card.Text className='mb-0'>Status: {task.status}</Card.Text>
          <Card.Text className='mb-0'>Created At: {formatDate(task.created_at)}</Card.Text>
